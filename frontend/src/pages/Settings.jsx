...
const Settings = () => {
    ...
    const handlePreferencesUpdate = async (e) => {
        ...
        setSaving(true)
        try {
            await api.put(`/users/prefrences`, preferences)
            toast.success('Preferences updated successfully');
        } catch (error) {
            console.error(error)
            toast.error("Failed To Update Prefrences")
        } finally {
            setSaving(false)
        }
    };
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            {deleteAccountOpen && (
                <DeleteConfirmModal
                    ...
                    description='This will permanently delete your account and all data. Type "DELETE" to confirm.'
